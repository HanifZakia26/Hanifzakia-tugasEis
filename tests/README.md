...
* [CodeIgniter 4 User Guide on Testing](https://codeigniter.com/user_guide/testing/index)
...
The HTML files can be viewed by opening **tests/coverage/index** in your favorite browser.
